    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm025_p2_mimic', name: '模倣', icon: '🌀', powerMult: 1.72, ctWeight: 'standard', intent: 'STRONG', telegraph: '演算脳塊がこちらの構えを見透かしている…！' },
          ...
          { id: 'enm025_p2_analyze', name: '解析', icon: '🔍', powerMult: 0.69, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'accuracy_down', magnitude: 10, turns: 2 } },
        ],
      },
    ],
  },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm026_p2_dance', name: '腕乱舞', icon: '💫', powerMult: 2.07, ctWeight: 'very_heavy', intent: 'ULTIMATE', applyStatus: { kind: 'vulnerable', magnitude: 10, turns: 3 }, hits: 6, telegraph: '百手鬼の腕が無数に蠢き始めた…！' },
          { id: 'enm026_p2_combo', name: '連撃', icon: '🌀', powerMult: 1.03, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'vulnerable', magnitude: 8, turns: 2 }, hits: 3 },
          { id: 'enm026_p2_barrage', name: '粉砕連打', icon: '🔨', powerMult: 1.26, ctWeight: 'heavy', intent: 'STRONG', applyStatus: { kind: 'defense_down', magnitude: 5, turns: 2 }, hits: 4 },
        ],
      },
    ],
  },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm027_p2_desperate', name: '背水撃', icon: '🩸', powerMult: 1.84, ctWeight: 'heavy', intent: 'ULTIMATE', executeBonus: { hpPctThreshold: 40, bonusMult: 2.5 }, telegraph: '断頭獣がとどめを狙っている…！' },
          { id: 'enm027_p2_shatter', name: '破砕撃', icon: '🔨', powerMult: 1.15, ctWeight: 'standard', intent: 'ATTACK' },
          { id: 'enm027_p2_execute', name: '処刑', icon: '💀', powerMult: 0.92, ctWeight: 'standard', intent: 'STRONG', executeBonus: { hpPctThreshold: 30, bonusMult: 2.2 } },
        ],
      },
    ],
  },
    ...
    phases: [
      {
        ...
        moves: [
          ...
          { id: 'enm028_p2_fang', name: '氷結牙', icon: '🧊', powerMult: 0.92, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'frozen', magnitude: 20, turns: 2 } },
          { id: 'enm028_p2_shatter', name: '凍砕', icon: '❄️', powerMult: 1.15, ctWeight: 'standard', intent: 'STRONG', applyStatus: { kind: 'frozen', magnitude: 15, turns: 2 } },
        ],
      },
    ],
  },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm029_p2_flash', name: '瞬歩', icon: '💨', powerMult: 1.49, ctWeight: 'standard', intent: 'STRONG', selfApplyStatus: { kind: 'haste', magnitude: 30, turns: 2 }, telegraph: '雷角獣の姿がかき消えた…！' },
          { id: 'enm029_p2_claw', name: '雷爪', icon: '⚡', powerMult: 0.92, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'shock', magnitude: 1, turns: 3 } },
          { id: 'enm029_p2_chain', name: '雷鎖', icon: '🔗', powerMult: 0.69, ctWeight: 'standard', intent: 'DEBUFF', applyStatus: { kind: 'paralyze', magnitude: 20, turns: 1 } },
        ],
      },
    ],
  },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm030_p2_mimic', name: '模倣', icon: '🌀', powerMult: 1.72, ctWeight: 'standard', intent: 'STRONG', telegraph: '混成獣の姿が揺らめいている…！' },
          { id: 'enm030_p2_mutate', name: '変異', icon: '🧬', powerMult: 0.92, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'vulnerable', magnitude: 10, turns: 2 } },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm031_p2_gale', name: '疾風連打', icon: '🌀', powerMult: 0.34, ctWeight: 'light', intent: 'STRONG', applyStatus: { kind: 'vulnerable', magnitude: 15, turns: 2 }, hits: 3, telegraph: '瞬足キメラの動きが加速していく…！' },
          { id: 'enm031_p2_quick', name: '速撃', icon: '⚡', powerMult: 0.8, ctWeight: 'light', intent: 'ATTACK' },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm032_p2_final', name: '終焉の一撃', icon: '🌋', powerMult: 2.99, ctWeight: 'very_heavy', intent: 'ULTIMATE', applyStatus: { kind: 'slow', magnitude: 25, turns: 2 }, telegraph: '重神キメラが「終焉の一撃」の構え…!!' },
          { id: 'enm032_p2_smash', name: '強打', icon: '👊', powerMult: 1.49, ctWeight: 'heavy', intent: 'STRONG' },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm033_p2_burst', name: '毒爆', icon: '☠️', powerMult: 1.61, ctWeight: 'heavy', intent: 'STRONG', applyStatus: { kind: 'poison', magnitude: 8, turns: 4 }, telegraph: '毒王蠍の毒嚢が膨れ上がる…！' },
          { id: 'enm033_p2_sting', name: '毒針', icon: '🧪', powerMult: 0.69, ctWeight: 'light', intent: 'POISON', applyStatus: { kind: 'poison', magnitude: 4, turns: 4 } },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm034_p2_burst', name: '炎上爆破', icon: '💥', powerMult: 2.07, ctWeight: 'heavy', intent: 'STRONG', applyStatus: { kind: 'burn', magnitude: 7, turns: 3 }, telegraph: '炎帝頭が業火をまとい始めた…！' },
          { id: 'enm034_p2_fang', name: '火炎牙', icon: '🔥', powerMult: 0.92, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'burn', magnitude: 4, turns: 3 } },
          { id: 'enm034_p2_smash', name: '強打', icon: '👊', powerMult: 1.26, ctWeight: 'heavy', intent: 'STRONG' },
        ],
      },
    ],
  },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm035_p2_howl', name: '咆哮', icon: '📣', powerMult: 0, ctWeight: 'heavy', intent: 'DEBUFF', applyStatus: { kind: 'fear', magnitude: 15, turns: 3 }, delayTargetBy: 92, telegraph: '時王が咆哮の気配を溜めている…！' },
          { id: 'enm035_p2_strike', name: '遅延打撃', icon: '⏳', powerMult: 0.8, ctWeight: 'standard', intent: 'DELAY', delayTargetBy: 63 },
          { id: 'enm035_p2_eat', name: '時間喰い', icon: '🕳️', powerMult: 0.57, ctWeight: 'standard', intent: 'DELAY', applyStatus: { kind: 'time_wound', magnitude: 20, turns: 3 }, delayTargetBy: 52 },
        ],
      },
    ],
  },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm036_p2_thorn', name: '棘返し', icon: '🦔', powerMult: 1.38, ctWeight: 'standard', intent: 'STRONG' },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm037_p2_undying', name: '不死の構え', icon: '🌟', powerMult: 0.69, ctWeight: 'heavy', intent: 'STRONG', selfApplyStatus: { kind: 'undying', magnitude: 1, turns: 3 }, telegraph: '再生王が致死をも耐える構えを見せた…！' },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm038_p2_burst', name: '魔力暴発', icon: '🔮', powerMult: 1.72, ctWeight: 'heavy', intent: 'STRONG', applyStatus: { kind: 'mp_leak', magnitude: 10, turns: 3 }, telegraph: '虚無喰いが魔力を吸い上げている…！' },
          { id: 'enm038_p2_drain', name: 'MP吸収', icon: '🕳️', powerMult: 0.57, ctWeight: 'standard', intent: 'DEBUFF', applyStatus: { kind: 'mp_leak', magnitude: 5, turns: 3 } },
          { id: 'enm038_p2_quick', name: '速撃', icon: '⚡', powerMult: 0.8, ctWeight: 'light', intent: 'ATTACK' },
        ],
      },
    ],
  },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm039_p2_selfblast', name: '自壊砲', icon: '💣', powerMult: 1.84, ctWeight: 'heavy', intent: 'ULTIMATE', selfApplyStatus: { kind: 'defense_down', magnitude: 10, turns: 2 }, telegraph: '暴君獣が自らを犠牲に力を高めている…！' },
          { id: 'enm039_p2_smash', name: '強打', icon: '👊', powerMult: 1.26, ctWeight: 'heavy', intent: 'STRONG' },
      ...
      },
      {
        ...
        moves: [
          { id: 'enm039_p3_selfblast', name: '自壊砲', icon: '💣', powerMult: 2.08, ctWeight: 'heavy', intent: 'ULTIMATE', selfApplyStatus: { kind: 'defense_down', magnitude: 10, turns: 2 }, telegraph: '暴君獣が自らを犠牲に力を高めている…！' },
          { id: 'enm039_p3_smash', name: '強打', icon: '👊', powerMult: 1.43, ctWeight: 'heavy', intent: 'STRONG' },
          { id: 'enm039_p3_selfblast_2', name: '自壊砲', icon: '💣', powerMult: 2.08, ctWeight: 'heavy', intent: 'ULTIMATE', selfApplyStatus: { kind: 'defense_down', magnitude: 10, turns: 2 }, telegraph: '暴君獣が自らを犠牲に力を高めている…！' },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm040_p2_mimic', name: '模倣', icon: '🌀', powerMult: 1.72, ctWeight: 'standard', intent: 'STRONG', telegraph: '全視眼がこちらの構えを見透かしている…！' },
          ...
          { id: 'enm040_p2_analyze', name: '解析', icon: '🔍', powerMult: 0.69, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'accuracy_down', magnitude: 10, turns: 2 } },
        ],
      },
      {
        hpPctThreshold: 35,
        ...
        moves: [
          { id: 'enm040_p3_mimic', name: '模倣', icon: '🌀', powerMult: 1.95, ctWeight: 'standard', intent: 'STRONG', telegraph: '全視眼がこちらの構えを見透かしている…！' },
          ...
          { id: 'enm040_p3_mimic_2', name: '模倣', icon: '🌀', powerMult: 1.95, ctWeight: 'standard', intent: 'STRONG', telegraph: '全視眼がこちらの構えを見透かしている…！' },
          { id: 'enm040_p3_analyze', name: '解析', icon: '🔍', powerMult: 0.78, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'accuracy_down', magnitude: 10, turns: 2 } },
        ],
      },
    ],
  },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm041_p2_dance', name: '腕乱舞', icon: '💫', powerMult: 2.07, ctWeight: 'very_heavy', intent: 'ULTIMATE', applyStatus: { kind: 'vulnerable', magnitude: 10, turns: 3 }, hits: 6, telegraph: '千腕王の腕が無数に蠢き始めた…！' },
          { id: 'enm041_p2_combo', name: '連撃', icon: '🌀', powerMult: 1.03, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'vulnerable', magnitude: 8, turns: 2 }, hits: 3 },
          { id: 'enm041_p2_barrage', name: '粉砕連打', icon: '🔨', powerMult: 1.26, ctWeight: 'heavy', intent: 'STRONG', applyStatus: { kind: 'defense_down', magnitude: 5, turns: 2 }, hits: 4 },
        ],
      },
      {
        hpPctThreshold: 35,
        ...
        moves: [
          { id: 'enm041_p3_dance', name: '腕乱舞', icon: '💫', powerMult: 2.34, ctWeight: 'very_heavy', intent: 'ULTIMATE', applyStatus: { kind: 'vulnerable', magnitude: 10, turns: 3 }, hits: 6, telegraph: '千腕王の腕が無数に蠢き始めた…！' },
          { id: 'enm041_p3_combo', name: '連撃', icon: '🌀', powerMult: 1.17, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'vulnerable', magnitude: 8, turns: 2 }, hits: 3 },
          { id: 'enm041_p3_dance_2', name: '腕乱舞', icon: '💫', powerMult: 2.34, ctWeight: 'very_heavy', intent: 'ULTIMATE', applyStatus: { kind: 'vulnerable', magnitude: 10, turns: 3 }, hits: 6, telegraph: '千腕王の腕が無数に蠢き始めた…！' },
          { id: 'enm041_p3_barrage', name: '粉砕連打', icon: '🔨', powerMult: 1.43, ctWeight: 'heavy', intent: 'STRONG', applyStatus: { kind: 'defense_down', magnitude: 5, turns: 2 }, hits: 4 },
        ],
      },
    ],
  },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm042_p2_desperate', name: '背水撃', icon: '🩸', powerMult: 1.84, ctWeight: 'heavy', intent: 'ULTIMATE', executeBonus: { hpPctThreshold: 40, bonusMult: 2.5 }, telegraph: '処刑王がとどめを狙っている…！' },
          { id: 'enm042_p2_shatter', name: '破砕撃', icon: '🔨', powerMult: 1.15, ctWeight: 'standard', intent: 'ATTACK' },
          { id: 'enm042_p2_execute', name: '処刑', icon: '💀', powerMult: 0.92, ctWeight: 'standard', intent: 'STRONG', executeBonus: { hpPctThreshold: 30, bonusMult: 2.2 } },
        ],
      },
      {
        hpPctThreshold: 35,
        ...
        moves: [
          { id: 'enm042_p3_desperate', name: '背水撃', icon: '🩸', powerMult: 2.08, ctWeight: 'heavy', intent: 'ULTIMATE', executeBonus: { hpPctThreshold: 40, bonusMult: 2.5 }, telegraph: '処刑王がとどめを狙っている…！' },
          { id: 'enm042_p3_shatter', name: '破砕撃', icon: '🔨', powerMult: 1.3, ctWeight: 'standard', intent: 'ATTACK' },
          { id: 'enm042_p3_desperate_2', name: '背水撃', icon: '🩸', powerMult: 2.08, ctWeight: 'heavy', intent: 'ULTIMATE', executeBonus: { hpPctThreshold: 40, bonusMult: 2.5 }, telegraph: '処刑王がとどめを狙っている…！' },
          { id: 'enm042_p3_execute', name: '処刑', icon: '💀', powerMult: 1.04, ctWeight: 'standard', intent: 'STRONG', executeBonus: { hpPctThreshold: 30, bonusMult: 2.2 } },
        ],
      },
    ],
  },
    ...
    phases: [
      {
        ...
        moves: [
          ...
          { id: 'enm043_p2_fang', name: '氷結牙', icon: '🧊', powerMult: 0.92, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'frozen', magnitude: 20, turns: 2 } },
          { id: 'enm043_p2_shatter', name: '凍砕', icon: '❄️', powerMult: 1.15, ctWeight: 'standard', intent: 'STRONG', applyStatus: { kind: 'frozen', magnitude: 15, turns: 2 } },
        ],
      },
      {
        hpPctThreshold: 35,
        ...
        moves: [
          ...
          { id: 'enm043_p3_fang', name: '氷結牙', icon: '🧊', powerMult: 1.04, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'frozen', magnitude: 20, turns: 2 } },
          { id: 'enm043_p3_guard_2', name: '完全防御', icon: '🛡️', powerMult: 0, ctWeight: 'light', intent: 'GUARD', telegraph: '氷獄獣が完全な守りに入った…！' },
          { id: 'enm043_p3_shatter', name: '凍砕', icon: '❄️', powerMult: 1.3, ctWeight: 'standard', intent: 'STRONG', applyStatus: { kind: 'frozen', magnitude: 15, turns: 2 } },
        ],
      },
    ],
  },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm044_p2_flash', name: '瞬歩', icon: '💨', powerMult: 1.49, ctWeight: 'standard', intent: 'STRONG', selfApplyStatus: { kind: 'haste', magnitude: 30, turns: 2 }, telegraph: '雷帝鳥の姿がかき消えた…！' },
          { id: 'enm044_p2_claw', name: '雷爪', icon: '⚡', powerMult: 0.92, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'shock', magnitude: 1, turns: 3 } },
          { id: 'enm044_p2_chain', name: '雷鎖', icon: '🔗', powerMult: 0.69, ctWeight: 'standard', intent: 'DEBUFF', applyStatus: { kind: 'paralyze', magnitude: 20, turns: 1 } },
        ],
      },
      {
        hpPctThreshold: 35,
        ...
        moves: [
          { id: 'enm044_p3_flash', name: '瞬歩', icon: '💨', powerMult: 1.69, ctWeight: 'standard', intent: 'STRONG', selfApplyStatus: { kind: 'haste', magnitude: 30, turns: 2 }, telegraph: '雷帝鳥の姿がかき消えた…！' },
          { id: 'enm044_p3_claw', name: '雷爪', icon: '⚡', powerMult: 1.04, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'shock', magnitude: 1, turns: 3 } },
          { id: 'enm044_p3_flash_2', name: '瞬歩', icon: '💨', powerMult: 1.69, ctWeight: 'standard', intent: 'STRONG', selfApplyStatus: { kind: 'haste', magnitude: 30, turns: 2 }, telegraph: '雷帝鳥の姿がかき消えた…！' },
          { id: 'enm044_p3_chain', name: '雷鎖', icon: '🔗', powerMult: 0.78, ctWeight: 'standard', intent: 'DEBUFF', applyStatus: { kind: 'paralyze', magnitude: 20, turns: 1 } },
        ],
      },
    ],
  },
    ...
    phases: [
      {
        ...
        moves: [
          { id: 'enm045_p2_mimic', name: '模倣', icon: '🌀', powerMult: 1.72, ctWeight: 'standard', intent: 'STRONG', telegraph: '原初キメラの姿が揺らめいている…！' },
          { id: 'enm045_p2_mutate', name: '変異', icon: '🧬', powerMult: 0.92, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'vulnerable', magnitude: 10, turns: 2 } },
      ...
      },
      {
        ...
        moves: [
          { id: 'enm045_p3_mimic', name: '模倣', icon: '🌀', powerMult: 1.95, ctWeight: 'standard', intent: 'STRONG', telegraph: '原初キメラの姿が揺らめいている…！' },
          { id: 'enm045_p3_mutate', name: '変異', icon: '🧬', powerMult: 1.04, ctWeight: 'standard', intent: 'ATTACK', applyStatus: { kind: 'vulnerable', magnitude: 10, turns: 2 } },
          { id: 'enm045_p3_mimic_2', name: '模倣', icon: '🌀', powerMult: 1.95, ctWeight: 'standard', intent: 'STRONG', telegraph: '原初キメラの姿が揺らめいている…！' },
